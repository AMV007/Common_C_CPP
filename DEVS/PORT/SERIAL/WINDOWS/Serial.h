...
public:
	...
	virtual LONG Write (const void* pData, DWORD iLen, DWORD* pdwWritten = NULL, LPOVERLAPPED lpOverlapped = NULL, DWORD dwTimeout = INFINITE);
	virtual LONG Write (LPCSTR pString, DWORD* pdwWritten = NULL, LPOVERLAPPED lpOverlapped = NULL, DWORD dwTimeout = INFINITE);
	...
	virtual LONG Read (void* pData, DWORD iLen, DWORD* pdwRead = NULL, LPOVERLAPPED lpOverlapped = NULL, DWORD dwTimeout = INFINITE);
