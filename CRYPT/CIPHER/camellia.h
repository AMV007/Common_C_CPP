 ...
 */
int camellia_setkey_enc( camellia_context *ctx, const unsigned char *key, __int32 keysize );
 ...
 * \return         0 if successful, or POLARSSL_ERR_CAMELLIA_INVALID_KEY_LENGTH
 */
int camellia_setkey_dec( camellia_context *ctx, const unsigned char *key, __int32 keysize );
 ...
 */
int camellia_self_test( __int32 verbose );
