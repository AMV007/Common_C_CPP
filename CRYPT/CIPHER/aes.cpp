...
static __int32 aes_init_done = 0;
 ...
 */
int aes_setkey_enc( aes_context *ctx, const unsigned char *key, __int32 keysize )
{
    __int32 i;
    unsigned long *RK;
 ...
 */
int aes_setkey_dec( aes_context *ctx, const unsigned char *key, __int32 keysize )
{
    __int32 i, j;
    aes_context cty;
    unsigned long *RK;
 ...
 * Checkup routine
 */
int aes_self_test( __int32 verbose )
{
    __int32 i, j, u, v, offset;
