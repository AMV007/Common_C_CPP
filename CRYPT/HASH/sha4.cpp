 ...
 */
void sha4_starts( sha4_context *ctx, __int32 is384 )
{
    ctx->total[0] = 0;
    ctx->total[1] = 0;
 ...
 */
void sha4_update( sha4_context *ctx, const unsigned char *input, __int32 ilen )
{
    __int32 fill;
    unsigned int64 left;
 ...
 */
void sha4( const unsigned char *input, __int32 ilen,
           unsigned char output[64], __int32 is384 )
{
    sha4_context ctx;
 ...
 */
int sha4_file( const char *path, unsigned char output[64], __int32 is384 )
{
    FILE *f;
    size_t n;
    sha4_context ctx;
 ...
 */
void sha4_hmac_starts( sha4_context *ctx, const unsigned char *key, __int32 keylen,
                       __int32 is384 )
{
    __int32 i;
 ...
 */
void sha4_hmac( const unsigned char *key, __int32 keylen,
                const unsigned char *input, __int32 ilen,
                unsigned char output[64], __int32 is384 )
{
    sha4_context ctx;
...
static const __int32 sha4_test_buflen[3] =
{
    3, 112, 1000
};
...
static const __int32 sha4_hmac_test_keylen[7] =
{
...
static const __int32 sha4_hmac_test_buflen[7] =
{
 ...
 * Checkup routine
 */
int sha4_self_test( __int32 verbose )
{
