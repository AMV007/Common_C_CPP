 ...
 * MD5 process buffer
 */
void md5_update( md5_context *ctx, const unsigned char *input, __int32 ilen )
{
    __int32 fill;
    unsigned long left;
 ...
 */
void md5( const unsigned char *input, __int32 ilen, unsigned char output[16] )
{
    md5_context ctx;
 ...
 */
void md5_hmac_starts( md5_context *ctx, const unsigned char *key, __int32 keylen )
{
    __int32 i;
 ...
 */
void md5_hmac_update( md5_context *ctx, const unsigned char *input, __int32 ilen )
{
    md5_update( ctx, input, ilen );
}
 ...
 */
void md5_hmac( const unsigned char *key, __int32 keylen,
...
static const __int32 md5_test_buflen[7] =
{
    0, 1, 3, 14, 26, 62, 80
};
...
static const __int32 md5_hmac_test_keylen[7] =
{
    16, 4, 16, 25, 16, 80, 80
};
...
static const __int32 md5_hmac_test_buflen[7] =
{
    8, 28, 50, 50, 20, 54, 73
};
 ...
 * Checkup routine
 */
int md5_self_test( __int32 verbose )
{
    __int32 i, buflen;
    unsigned char buf[1024];
